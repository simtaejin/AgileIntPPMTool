...
public class BacklogController {
    ...
    public ResponseEntity<?> addTtoBacklog(@Valid @RequestBody ProjectTask projectTask, BindingResult result, @PathVariable String backlog_id, Principal principal) {
    ...
    public ResponseEntity<?> getProejctTask(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal) {
